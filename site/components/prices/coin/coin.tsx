...
import SwiperCoin from "./swiper-coin";
...
const Coin: React.FC<{ theme: string }> = ({ theme }) => {
  ...
  return (
    <div className="w-[80%] mx-auto screen900:w-[90%] screen900:pt-10">
      <div className="flex flex-row-reverse justify-between">
        <p
          className="text-[40px] text-right font-bold w-[34%] my-auto 
          screen1230:text-[30px] screen950:text-[28px] screen900:text-[20px] screen700:w-[50%] screen500:w-[60%] screen400:text-[18px] screen360:text-[16px]"
        >
          قیمت های به روز سکه
        </p>

        <div className="w-[66%] mr-auto flex flex-row justify-between">
          <div className="flex flex-row-reverse space-x-5 space-x-reverse w-full justify-end screen700:space-x-2 screen700:space-x-reverse">
            ...
            <div className="flex flex-row-reverse space-x-2 space-x-reverse screen700:space-x-1 screen700:space-x-reverse">
              <div
                ...
                className={`swiper-next-coin py-4 px-9 ${
              ...
              <div
                ...
                className={`swiper-prev-coin py-4 px-9 ${
                  theme === "light" ? "bg-[#844DB4]" : "bg-[#1C1740]"
                }  rounded-[8px] cursor-pointer screen1280:py-2 mx-auto my-auto
                screen700:px-4 screen700:py-1 screen400:px-3 screen400:py-0.5`}
              >
